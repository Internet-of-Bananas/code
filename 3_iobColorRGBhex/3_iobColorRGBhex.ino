/***************************************************
  ...
  *** IoB Color - convert to RGB hexadecimal ***
  This skectch converts the value from red, green and blue to hexadecimal notation.
...
void loop() {
  ...
  */
  ...
  strRGB = "#" + strRed + strGreen + strBlue; // Join the RGB with the #.
